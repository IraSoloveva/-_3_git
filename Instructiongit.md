...
Для того, чтобы увидеть все ответвления от базовой версии документа, отследить сделанные в разные ветках сохранения и историю слияний веток испоьлзуется команда *git log --oneline --all --graph*.
